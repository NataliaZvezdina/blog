...
public class CommentFullDto {
    ...
    public CommentFullDto(long commentId, long postId, String message, String authorName, int rating, Date createdAt) {
    ...
    public static class Builder {
        private CommentFullDto comment = new CommentFullDto();
    ...
    public boolean equals(Object o) {
        ...
        CommentFullDto comment = (CommentFullDto) o;
